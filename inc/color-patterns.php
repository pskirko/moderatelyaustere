<?php
/**
 * Moderately Austere: Color Patterns
 *
 * @package WordPress
 ...
 */
function moderatelyaustere_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter Moderately Austere default saturation level.
	 *
	 * @since Moderately Austere 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'moderatelyaustere_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.moderatelyaustere-front-page) .entry-title,
...
.colors-custom .moderatelyaustere-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.moderatelyaustere-front-page .panel-content .recent-posts article,
...
.colors-custom.moderatelyaustere-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters Moderately Austere custom colors CSS.
	 *
	 * @since Moderately Austere 1.0
	 *
	 ...
	 */
	return apply_filters( 'moderatelyaustere_custom_colors_css', $css, $hue, $saturation );
}
